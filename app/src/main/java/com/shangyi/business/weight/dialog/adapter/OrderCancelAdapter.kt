 ...
 * Desc:
 */
class OrderCancelAdapter : BaseQuickAdapter<String, BaseViewHolder>(R.layout.item_order_cancel_view) {
    ...
    override fun convert(holder: BaseViewHolder, item: String) {
        ...
        holder.itemView.setOnClickListener {
            selectItemPosition = holder.layoutPosition
